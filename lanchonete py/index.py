...
print("Olá, seja bem vido a Lanchonete do Luiz Gustavo dos Santos")
...
# faça  um dicionário com os códigos, nomes e preços dos produtos
...
# faça uma lista vazia para armazenar os pedidos
